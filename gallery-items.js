...
ul.innerHTML = galleryItems.join("");
...
const currentActiveImage = document.querySelector("ul.js-gallery");
if (currentActiveImage) {
  currentActiveImage.classList.remove(".gallery__image");
}
const nextActiveImage = evt.target;
nextActiveImage.classList.add(".gallery__image");
